...
async function rodar() {
  ...
  try {
    ...
    // O Python devolve a distância matemática. Multiplicar por 111 aprox. para km.
    const km = (data.custo * 111).toFixed(2);
    ...
    alert('Não foi possível conectar ao backend.\nVerifique se app.py está rodando na porta 5000.');
  } finally {
...
function desenharRotaNoMapa(ordemIndices) {
  ...
  coordenadasOrdenadas.push(coordenadasOrdenadas); // Fecha o ciclo da viagem
